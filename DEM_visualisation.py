...
def importDemAsArray(path, xsize=None, ysize=None, xoff=0, yoff=0):
    ...
    Входной dataset преобразуется в систему координат EPSG:3857 - Pseudo Mercator (прямоугольная система с учетом
    кривизны Земли)
    ...
    outputEPSG = 3857  # Pseudo Mercator
